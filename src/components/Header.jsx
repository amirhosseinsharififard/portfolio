import {Grid, Button, Box, FormControlLabel} from "@mui/material";
...
// }));
const Header = () => {
  const [hovered, setHovered] = useState({index1: false, index2: false});
  const linksForEach = [
    "Classic List",
    "Classic Grid",
    "Classic Overlay",
      ...
      <Grid item display='flex' justifyContent={"space-between"} md={6}>
        <Box
          ...
          <Button
            ...
            {hovered.index1 ? <KeyboardArrowUpIcon /> : <ExpandMoreIcon />}
            HomePages
          </Button>
          <div className={styles.dropDownContent}>
            {linksForEach.map((item) => (
        ...
        <Box
          ...
          onMouseLeave={() => handleMouseLeave("index2")}>
          <Button
            sx={{
              textDecoration: "none",
              color: "#29294b",
            ...
            {hovered.index2 ? <KeyboardArrowUpIcon /> : <ExpandMoreIcon />}
            Featurs
          </Button>
          <div className={styles.dropDownContent}>
            <a href='#'>Home 1</a>
